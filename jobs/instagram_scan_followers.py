...
class InstagramScanFollowersJob(TaciturnJob):
    __jobname__ = 'instagram_scan_followers'
    ...
    def run(self):
        ...
        TaskExecutor(call=lambda: instagram_handler.update_followers(),
                     job_name=self.job_name(),
                     handler_stats=scan_stats)\
                .run()


job = InstagramScanFollowersJob
