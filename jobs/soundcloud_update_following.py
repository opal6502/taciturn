...
class SoundcloudUpdateFollowingJob(TaciturnJob):
    __jobname__ = 'soundcloud_update_following'
    ...
    def run(self):
        ...
        for retry_n in range(1, round_retries + 1):
            try:
                soundcloud_handler.update_following()
            ...
            print("soundcloud_update_following: failed after {} tries!".format(retry_n))

        print("Job complete.")
        soundcloud_handler.quit()


job = SoundcloudUpdateFollowingJob()
