...
class SoundcloudScanFollowersJob(TaciturnJob):
    __jobname__ = 'soundcloud_scan_followers'
    ...
    def run(self):
        ...
        TaskExecutor(call=lambda: soundcloud_handler.update_followers(),
                     job_name=self.job_name(),
                     handler_stats=scan_stats)\
                .run()


job = SoundcloudScanFollowersJob
